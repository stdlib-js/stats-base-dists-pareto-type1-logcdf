...
tape( 'the function returns `0.0` if provided `+Infinity` and valid parameters', opts, function test( t ) {
	var y = logcdf( PINF, 2.0, 2.0 );
	t.strictEqual( y, 0.0, 'returns expected value' );
	t.end();
});

tape( 'if provided a number smaller than `beta` for `x` and a valid `alpha` and `beta`, the function returns `-Infinity`', opts, function test( t ) {
